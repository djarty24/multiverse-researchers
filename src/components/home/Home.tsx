            ...
            <div className="bg-[url('/imgs/filler/Background.png')] pb-32" style={backgroundWrapping}>
                ...
                <div className="mb-32">
                    ...
                    <div className="m-auto w-4/5 flex flex-col md:flex-row justify-evenly gap-4 lg:w-2/3">
                        ...
                        <div className="md:w-1/4 text-purple-600 hover:text-pink-600 transition-all bg-white shadow-lg rounded-lg px-6 py-8 flex flex-col justify-between hover:shadow-2xl duration-300">
                            <p className="text-xl font-semibold text-center text-gray-800">Monthly Reads</p>
                            <p className="text-3xl font-bold text-center text-purple-600 py-4">45k</p>
                        </div>
                    </div>
                </div>

                {/* Research Groups Section: Now responsive! */}
                <div className="flex flex-col w-full items-center">
                    ...
                    {/* Adjusted width for mobile and added padding */}
                    <Tabs defaultValue="physics" className="w-11/12 lg:w-2/3 p-1">
                        {/* Added flex-wrap to allow tabs to wrap on smaller screens */}
                        <TabsList className="flex flex-wrap justify-center h-fit bg-white shadow-lg border border-gray-100 rounded-lg mb-12">
                            {/* Added a small margin (m-1) to each trigger for spacing when wrapped */}
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="envisci">Environmental Science Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="astronomy">Astronomy Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="physics">Physics Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="econ">Economics Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="compsci">Computer Science Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="aerospace">Aerospace Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="polisci">Political Science Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="bio">Biology Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="math">Mathematics Group</TabsTrigger>
                            <TabsTrigger className="text-xs hover:bg-gray-100 focus:bg-gray-100 focus:text-blue-500 focus:font-semibold p-2 m-1" value="psych">Psychology Group</TabsTrigger>
                        </TabsList>

                        <TabsContent value="bio" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="envisci" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="aerospace" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="astronomy" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="physics" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="econ" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="compsci" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
                        ...
                        <TabsContent value="polisci" className="p-8 bg-white border border-gray-100 rounded-lg shadow-xl">
                            <div className="circle-snippet m-auto w-full lg:w-2/3">
